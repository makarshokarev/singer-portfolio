        ...
        <section className="relative" aria-label={translations.vocalist}>
          ...
          <div className="container relative z-10 py-24 md:py-36 lg:py-48">
            <div className="max-w-2xl text-white">
              <h1 className="text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl">Jekaterina Margalnikova</h1>
              ...
              <div>
                <div className="relative aspect-[4/3] overflow-hidden rounded-lg">
                  <Image
                    ...
                    fill
                    className="object-cover object-[75%_35%] transition-transform hover:scale-105"
                  />
                </div>
              </div>
              <div>
